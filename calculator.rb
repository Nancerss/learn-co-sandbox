...
#   puts "Your total tuition for this semester will be #{tuition}"
# else
#   puts "If you are in you're 5th year of college of higher, we reccomend finding a sugar daddy (or two) because you will never pay off that debt."
# end

puts "Hi there and welcome to your" 
puts "Please choose from one of the following actions: 
  addition,
  subtraction,
  multiplication,
  division."
  
  actions = gets.chomp.downcase
